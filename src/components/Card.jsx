...
import { todosCleared } from "../Store/store";
...
const Card = () => {
  ...
  if (toggle) {
    return (
      <div className="w-1/2 h-3/4 min-h-max bg-green-100 shadow-2xl drop-shadow-2xl rounded-lg p-2 items-center flex flex-col space-y-10 justify-between">
